...
export default function Profile() {
  ...
  const menuItems = [
    ...
    { icon: "notifications", title: "Notifications", subtitle: "Manage your preferences" },
    { icon: "security", title: "Privacy & Security", subtitle: "Account settings" },
          ...
          <View className="items-center">
            <View className="relative mb-4">
              <Image
                ...
                resizeMode="cover"
              />
              <Pressable className="absolute bottom-0 right-0 bg-orange-500 rounded-full p-2">
            ...
            <Text className="text-gray-700 text-center text-sm leading-5 px-4">
              {user.bio}
            </Text>
          </View>
        </Animated.View>
                ...
                <View className={`rounded-xl p-4 border shadow-sm ${
                  ...
                  <View className="items-center">
                    <View className={`w-12 h-12 rounded-full items-center justify-center mb-2 ${
                      achievement.earned ? 'bg-orange-500' : 'bg-gray-300'
                    }`}>
                      <MaterialIcons 
                    ...
                    <Text className={`font-bold text-sm text-center mb-1 ${
                      achievement.earned ? 'text-orange-900' : 'text-gray-700'
                    }`}>
                      {achievement.title}
                    </Text>
